...
| P0-DI-01  | Reservation create idempotent; retry ikinci kayıt üretmez      |    1,4,5 | Same-key owner/replay + commit sonrası yanıt kaybı E2E                                 | ✅ Kanıtlandı |
| P0-DI-02  | UTC instant + IANA timezone ve geçmiş kontrolü                 |    1,3,5 | Migration, DST-offset matrisi + tam yenilemede UI korunumu                             | ✅ Kanıtlandı |
