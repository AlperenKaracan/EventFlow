...
| Remote CI                 | PR 5 GitHub Actions                                                    | PR açılışı sonrası kanıt eklenecek                                                                       |
...
|   5 | Bütün P0 satırları `✅ Kanıtlandı`; clean-clone ve E2E yeşil, kullanıcı onayı alınmış               | 🟡 Remote CI ve merge onayı bekliyor |
